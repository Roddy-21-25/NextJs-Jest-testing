...
export default function AddItemForm({ setTodos }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex gap-2 items-center">
            ...
            <button
                type="submit"
                className="p-2 text-xl rounded-2xl text-black border-solid border-black border-2 max-w-xs
                 bg-green-500 hover:cursor-pointer hover:bg-green-400 disabled:bg-gray-300"
